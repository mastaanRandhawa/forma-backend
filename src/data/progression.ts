...
export const PROGRESSION_RULES: ProgressionRule[] = [
  ...
  },
  {
    ...
    requirementLabel: "Complete 1 workout session",
  ...
  },
  {
    ...
    any: [
      [{ counter: "activeDays", gte: 3 }],
      [{ counter: "finishedSessions", gte: 3 }],
    ],
    requirementLabel: "Be active for 3 days or complete 3 sessions",
    title: "Goals", deepLink: "/goals",
  },
  {
    feature: "programs", tier: "established", unlocks: "Multi-week programs",
    any: [[{ counter: "finishedSessions", gte: 5 }]],
    requirementLabel: "Complete 5 workout sessions",
  ...
  },
  {
    ...
    any: [[{ counter: "daysSinceFirstRun", gte: 7 }]],
    requirementLabel: "Use Forma for 7 days",
    title: "Detailed progress", deepLink: "/progress",
  },
  {
    feature: "achievements", tier: "established",
    unlocks: "Achievements strip + celebrations",
    any: [[{ counter: "prCount", gte: 1 }]],
    requirementLabel: "Set your first personal record",
  ...
  },
  {
    ...
    requirementLabel: "Earn your first coin",
    title: "The Kai store", deepLink: "/store",
  },
  {
    feature: "insights", tier: "established", unlocks: "Proactive coaching insights",
    any: [[{ counter: "finishedSessions", gte: 4 }]],
    requirementLabel: "Complete 4 workout sessions",
  ...
  },
  {
    ...
    requirementLabel: "Send 10 messages to Kai",
